...
public class FinnhubService extends Service {
    ...
    private final class ServiceHandler extends Handler {
        ...
        public void handleMessage(Message msg){
            ...
            String ticker = tickers.get(0).toString();
            String stringUrl =
    ...
    public int onStartCommand(Intent intent, int flags, int startId){
        ...
        ArrayList<CharSequence> tickers = new ArrayList<>(Arrays.asList("MSFT", "AAPL", "TSLA", "GME", "FB"));
        Bundle bundle = new Bundle();
        // Fill the bundle up with the tickers list
        bundle.putCharSequenceArrayList("tickers", tickers);
        msg.setData(bundle);
